...
- **For Creation:** Always consult **`references/patterns.md`**. This file dictates _how_ things should be built. Ignore generic approaches if a specific pattern exists here.
