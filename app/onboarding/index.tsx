  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <header style={styles.header}>
        <TouchableOpacity style={[styles.backButton, { backgroundColor: theme.surface }]}>
          <IconSymbol name="arrow.left.ios" size={20} color={theme.text} />
        </TouchableOpacity>
        
        <View style={styles.headerText}>
          <ThemedText type="title" style={styles.headline}>Choose your path</ThemedText>
          <ThemedText style={styles.subheadline}>
            We'll customize your tools and prayer focus based on your selected tradition.
          </ThemedText>
        </View>
      </header>
          ...
          {traditions.map((tradition) => (
            <TouchableOpacity 
              ...
              style={[
                ...
                { 
                  ...
                  borderColor: selectedTradition === tradition.id ? theme.primary : (colorScheme === 'light' ? '#e2e8f0' : '#1e293b')
                },
            ...
            >
              <View style={[
                ...
                { backgroundColor: colorScheme === 'light' ? tradition.bgColor.light : tradition.bgColor.dark }
              ]}>
              ...
              <View style={[
                styles.checkCircle,
                { borderColor: selectedTradition === tradition.id ? theme.primary : (colorScheme === 'light' ? '#cbd5e1' : '#334155') },
